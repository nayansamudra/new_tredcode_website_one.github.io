!(function ($) {
    ...
    $(".testimonials-carousel").owlCarousel({
        ...
        navigation: true,
        nav: true,
        navText: ['<i class="backleft-arrow"></i>', '<i class="nextright-arrow"></i>'],
        responsive: {
            0: {
                items: 1
            },
    ...
    $('.lightbox-toggle').on('click', (event) => {
        ...
        let content = 'https://tredcode.tradingcafeindia.com/' + $(event.currentTarget).attr('data-lightbox-content');
